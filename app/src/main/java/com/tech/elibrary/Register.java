...
//                reference = rootNode.getReference("Users");
                ...
                if (!validateUserName() | !validateEmail() | !validateAge() | !validatePhone() | !validatePassword()) {
                    MDToast mdToast = MDToast.makeText(Register.this, "Sign up failed", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR);
                    mdToast.show();
                }
                else{
                            ...
                            .addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        MDToast mdToast = MDToast.makeText(Register.this, "Sign up successfully", MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS);
                                        mdToast.show();
