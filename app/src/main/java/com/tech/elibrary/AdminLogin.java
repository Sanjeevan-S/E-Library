        ...
        log.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(editText1.getText().toString().equals("admin") && editText2.getText().toString().equals("admin")){
                    MDToast mdToast = MDToast.makeText(AdminLogin.this, "Successfully sign in", MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS);
                    mdToast.show();
                    Intent intent = new Intent(AdminLogin.this, AdminHome.class);
                    startActivity(intent);
                }else{
                    MDToast mdToast = MDToast.makeText(AdminLogin.this, "Sign in failed", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR);
                    mdToast.show();
                }
            }
        });
